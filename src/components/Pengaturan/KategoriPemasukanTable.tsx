...
import { useKategoriPemasukan, type KategoriPemasukan } from '@/hooks/useKategoriPemasukan';
import { useToast } from '@/hooks/use-toast';

export function KategoriPemasukanTable() {
  const { categories, loading, createCategory, updateCategory, deleteCategory, fetchCategories } = useKategoriPemasukan();
  ...
  const handleEdit = (category: KategoriPemasukan) => {
