...
DROP TRIGGER IF EXISTS sync_internal_payment_to_arus_kas_trigger ON public.internal_payments;
DROP TRIGGER IF EXISTS sync_invoice_to_arus_kas_trigger ON public.invoice;
