...
-- Create job_order_peserta table if it doesn't exist
...
-- Add kuota field to job_orders table
...
CREATE INDEX IF NOT EXISTS idx_job_order_peserta_job_order_id ON public.job_order_peserta(job_order_id);
CREATE INDEX IF NOT EXISTS idx_job_order_peserta_siswa_id ON public.job_order_peserta(siswa_id);
